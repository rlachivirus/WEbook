...
user13 = User.create!(email: 'user13@email.com', password: 'password', fname: name13[0], lname: name13[1], bio: Faker::Movies::HarryPotter.unique.quote, birthday: String(Faker::Date.unique.birthday))
...
user15 = User.create!(email: 'user15@email.com', password: 'password', fname: name15[0], lname: name15[1], bio: Faker::Movies::HarryPotter.unique.quote, birthday: String(Faker::Date.unique.birthday))
